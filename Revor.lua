...
and Redis:get(Revor.."lock_cleaner"..msg_chat_id) then
print("Clener >>> ")
DevRevor:sadd(Revor.."Revor:cleaner"..msg_chat_id,msg.id_)
Timerr = Redis:get(Revor..':Timer_Cleaner:'..msg_chat_id)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
Redis:setex(Revor..":SetTimerCleaner:"..msg_chat_id..msg.id_,Timerr or 21600,true)  
local Cleaner = Redis:get(Revor.."Revor:cleaner"..msg_chat_id)
for k,v in pairs(Cleaner) do
if not Redis:get(Revor.."Revor:cleaner"..msg_chat_id..v) then
DeleteMessage(msg_chat_id, {[0] = v}) 
DevRevor:srem(Revor.."Revor:cleaner"..msg_chat_id,v)
